    ...
    <div>
      <div className="card">
        <div className="card-header flex items-center justify-between flex-wrap gap-3">
          <div className="card-title font-semibold text-lg">Case Registry</div>
      ...
      {selectedCase && (
        <div className="card inspect-container mt-6">
          <div className="card-header" style={{ borderBottom: '1px solid var(--border)', paddingBottom: '16px', marginBottom: '20px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <div className="flex items-center gap-2.5 flex-wrap" style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
                <div className="card-title font-semibold" style={{ fontSize: '19px', margin: 0 }}>
            ...
            <div className="flex items-center gap-2" style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
              <button className="neu-btn primary transition" onClick={() => openAiDossier(caseDetail?.case_id || selectedCase, caseDetail?.case_name || selectedCase)}>
                ✨ AI Dossier
              </button>
              <button className="neu-btn ghost transition" onClick={() => changeView('graph')}>
                View in Graph Explorer →
              </button>
              <button className="neu-btn ghost transition hover:opacity-80" onClick={() => setSelectedCase(null)} title="Close Inspection">
                ✕
              </button>
            </div>
          </div>
          ...
          {loadingDetail ? (
            ...
            <div>
              ...
              {caseDetail.case_overlap?.has_overlap ? (
                <div className="overlap-banner alert-overlap-glow flex items-start gap-3">
                ...
                <div className="overlap-banner clean flex items-center gap-3">
              ...
              <div className={`inspect-grid grid gap-4`}>
                {/* 1. Primary Suspects */}
